...
export default function GlowHover({
  ...
  useEffect(() => {
    ...
    // Sync on scroll and resize — capture phase catches inner scroll containers
    window.addEventListener("scroll", syncCards, { capture: true, passive: true });
    ...
    return () => {
      ...
      window.removeEventListener("scroll", syncCards, { capture: true });
