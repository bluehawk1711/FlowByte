...
export class FavoritesController {
  ...
  has(@CurrentUser() user: AuthUser, @Param('songId', ParseUUIDPipe) songId: string): Promise<void> {
  ...
  add(@CurrentUser() user: AuthUser, @Param('songId', ParseUUIDPipe) songId: string): Promise<void> {
  ...
  remove(@CurrentUser() user: AuthUser, @Param('songId', ParseUUIDPipe) songId: string): Promise<void> {
