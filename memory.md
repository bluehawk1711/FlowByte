...
| 7. Mobile integration | 🔄 IN PROGRESS — API client, hybrid playback, offline downloads, favorites/playlists sync, playback push, Settings Cloud section ✅; **Cloud tab (browse/search/play/favorite/download cloud library) + Downloads screen (offline list, play/remove/clear) ✅**; remaining: per-playlist cloud sync UI polish, playing-screen polish for streamed songs |
